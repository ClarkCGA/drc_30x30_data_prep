...
def load_datasets(grid):
    return {
        ...
        'agb': ee.Image("projects/sat-io/open-datasets/ESA/ESA_CCI_AGB/CCI_BIOMASS_100m_AGB_2021_v51").clip(grid),
        ...
        'climate': ee.Image("projects/ee-madibipacifique/assets/ClimateVulnerability_VF").clip(grid),
